...
It's been already [5 episodes](https://letmeinux.com/). Incredible! I can see the progression from one week to another because I edit recordings and mix them together. We have become more confident in work with microphones. We are improving on how good we are prepared. And as a team, we gain a greater flow each week.
