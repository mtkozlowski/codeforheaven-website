        ...
        <div style={{ maxWidth: "950px" }}>
          <BadgesWrapper>
            <Badge src={javascript}>
              <H4>Javascript</H4>
              <p>
                Kapryśny, ale jednak król popularności wśród języków
                programowania. Nie mogło go tu zabraknąć. Uwielbiam jego
                możliwości i <i>community</i>.
              </p>
            </Badge>
            <Badge src={html}>
              <H4>HTML</H4>
              <p>
                Dobra i dostępna strona zaczyna się od przemyślanego i
                semantycznego HTMLu 🧱
              </p>
            </Badge>
            <Badge src={css}>
              <H4>CSS</H4>
              <p>
                Style mają moc. Nie tylko przykuwają wzrok, ale porządkują treść
                i sprawiają, że przyjemniej spędza się czas na stronie.
              </p>
            </Badge>
            <Badge src={gatsby}>
              <H4>GatsbyJS</H4>
              <p>
                Rok temu zwrócił moją uwagę i postanowiłem zbudować swój blog od
                zera w tej technologii. To portfolio również 💖
              </p>
            </Badge>
            <Badge src={ang}>
              <H4>English</H4>
              <p>
                Angielskiego zaczęła uczyć mnie ciocia, gdy miałem 6 lat. W 2011
                zdobyłem Certificate of Advanced English (CAE) 🎩
              </p>
            </Badge>
          </BadgesWrapper>
          <BadgesWrapper>
            ...
            <Wings src={git}>
              <H4>Git</H4>
              <p>
                Kontrola wersji, sprawny code review, branching i łatwa
                współpraca z innymi 🔫
              </p>
            </Wings>
          </BadgesWrapper>
